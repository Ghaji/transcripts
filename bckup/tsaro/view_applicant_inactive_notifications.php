...
<html>
	...
	<body>
		...
		<div class="row-fluid">
			...
			<div class="span9">
				<h2>Inactive Applicant Notifications</h2>
				<hr>
						<?php 
							$database = new MySQLDatabase();
							$active_notifications = "SELECT * FROM `applicant_notifications` as a JOIN `Personal_details` as p WHERE a.status = 2 AND a.sender_id = p.applicant_id AND a.recipient_id = ".$_SESSION['applicant_id'];
							...
							if($number_of_notifications == 0){
								echo '<p>You have no inactive applicant notification.</p>';
							}
						?>
