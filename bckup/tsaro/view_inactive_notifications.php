...
<html>
	...
	<body>
		...
		<div class="row-fluid">
			...
			<div class="span9">
				<h2>Inactive Notifications</h2>
				<hr>
						<?php 
							$database = new MySQLDatabase();
							$active_notifications = "SELECT * FROM `notifications` as n JOIN `admin_users` as a WHERE status = 2 AND n.user_id = a.user_id AND recipient = ".$_SESSION['applicant_id'];
