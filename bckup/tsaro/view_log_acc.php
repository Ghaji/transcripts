			...
			<div class="span9">
				...
				<form class="form-horizontal acceptance_log_details">
					...
					<div id="accept_terms">		
						<div class="control-group">
							  <div class="controls">
							  	<a href="search_acceptance_acceptance.php" class="btn btn-default" name="back_submit" id="back_submit">Back</a>  
								<button type="submit" class="btn btn-success" name="re_query_submit" id="re_query_submit">Re-Query</button>
								<button type="submit" class="btn btn-danger" name="clear_log_submit_acc" id="clear_log_submit_acc">Delete Record</button>
                                <button type="submit" class="btn btn-primary" name="Update_acc" id="update_acc">Update</button>
						      </div>
						</div>
					</div>
