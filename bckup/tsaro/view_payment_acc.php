			...
			<div class="span9">
				...
				<form class="form-horizontal adm_access_details">
					...
					<div id="accept_terms">		
						<div class="control-group">
							  <div class="controls">
							  	<a href="search_adm_acceptance.php" class="btn btn-default" name="back_submit" id="back_submit">Back</a>  
								<button type="submit" class="btn btn-danger" name="clear_log_acc_submit" id="clear_log_acc_submit">Delete Record</button>
