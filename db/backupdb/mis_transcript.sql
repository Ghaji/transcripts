...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 15, 2015 at 11:42 AM
...
(28, 'nat12399671', '01', 'Approved', 8600, '', '', '', 'nat12399671', 'a:3:{s:14:"Processing Fee";s:4:"7500";s:14:"Postage Charge";s:4:"1000";s:18:"Transaction Charge";i:100;}', '', '2015-10-13 15:25:15', '0000-00-00 00:00:00', ''),
...
(27, 'nat23584151', '01', 'Approved', 8600, '', '', '', 'nat23584151', 'a:3:{s:14:"Processing Fee";s:4:"7500";s:14:"Postage Charge";s:4:"1000";s:18:"Transaction Charge";i:100;}', '', '2015-10-13 15:25:15', '0000-00-00 00:00:00', '');
...
(1, 'int12345691', 0, 1, 1, '2015-10-07 10:32:10', '2015-10-03 02:09:20', '', 0, 0, 1),
(2, 'int12345691', 0, 2, 2, '2015-10-07 10:32:23', '2015-10-03 02:09:09', '', 0, 0, 1),
(11, 'int12345691', 0, 3, 3, '2015-10-07 10:32:36', '2015-10-03 02:10:06', '', 0, 0, 1),
(12, 'int12345691', 0, 4, 4, '2015-10-07 10:32:46', '2015-10-04 02:06:09', '6767', 1, 0, 1),
(14, 'nat12399671', 0, 1, 1, '2015-10-07 10:32:46', '2015-10-04 02:06:09', '', 0, 0, 1),
(15, 'nat12399671', 0, 2, 2, '2015-10-08 10:32:46', '2015-10-10 02:06:09', '', 0, 0, 1);
...
INSERT INTO `app_histories` (`id`, `application_no`, `applicant_id`, `type_id`, `mode_id`, `city_or_state`, `receiving_address`, `application_flag`, `reason`, `created_at`, `updated_at`, `app_visible`) VALUES
(5, 'nat12399671', 1, 2, 2, 1, 'London West 23  Chelsea street ', 1, '0', '2015-09-02 03:10:10', '2015-09-09 02:08:09', 1),
(6, 'nat84253151', 1, 0, 0, 0, '', 0, '0', '2015-10-13 13:11:55', '2015-10-13 13:11:55', 1),
(7, 'int67897151', 1, 2, 4, 1, '', 0, '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0),
(8, 'nat23584151', 1, 1, 2, 19, '', 0, '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0);
...
INSERT INTO `faqs` (`id`, `quetion`, `answer`, `admin_id`, `created_at`, `updated_at`, `visible`) VALUES
...
INSERT INTO `feedbacks` (`id`, `applicant_id`, `programme_id`, `title_id`, `comment`, `created_at`, `updated_at`, `visible`) VALUES
(13, 1, 1, 0, 'Test', '2015-10-14 11:24:23', '2015-10-14 11:24:23', 1),
(23, 1, 1, 1, 'This is yet another test', '2015-10-15 10:14:29', '2015-10-15 10:14:29', 1),
(24, 1, 1, 1, 'Yet another test', '2015-10-15 10:22:26', '2015-10-15 10:22:26', 1);
...
(1, 1, 'uj/2004/ns/0987', 1, 'Mohammed Ahmed Ghaji', 2, '1985-10-03', 'mohammedghaji@gamil.com', 'daaeb0893724461ac083047b0bbb6160', '08077766788', '&lt;p&gt;University Staff Quarters, Jos, Plateau State&lt;/p&gt;', 1, 2008, 2004, 0, 0, '&lt;p&gt;University of Ibadan, Ibadan&lt;/p&gt;', 1, '2015-09-28 23:00:00', '2015-10-13 13:11:55', '2015-10-15 09:08:47', 0, 1, 1, '34XCVB');
...
CREATE TABLE IF NOT EXISTS `qualification` (
  `qualificaton_type_id` int(11) NOT NULL,
...
INSERT INTO `title` (`title_id`, `title_name`, `title_visible`) VALUES
(1, 'Mr', 1),
(2, 'Miss', 1),
(3, 'Mrs', 1),
(4, 'Dr', 1);
...
--
-- Indexes for table `acceptance_log`
--
...
--
-- Indexes for table `adm_access_code`
--
ALTER TABLE `adm_access_code`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `applicant_status`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `applicant_id` (`application_no`,`status_id`,`delivery_company_id`) USING BTREE;
...
ALTER TABLE `app_histories`
  ADD PRIMARY KEY (`id`),
  ADD KEY `application_no` (`application_no`,`applicant_id`);
...
ALTER TABLE `personal_details`
  ...
  ADD KEY `mode_of_entry_id` (`mode_of_entry_id`),
...
ALTER TABLE `programmes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `qualification_type_id` (`qualificaton_type_id`),
  ADD KEY `department_id` (`department_id`);

--
-- Indexes for table `programme_category`
--
ALTER TABLE `programme_category`
...
ALTER TABLE `qualification`
  ADD PRIMARY KEY (`qualificaton_type_id`);
...
--
-- AUTO_INCREMENT for table `acceptance_log`
--
ALTER TABLE `acceptance_log`
...
--
-- AUTO_INCREMENT for table `adm_access_code`
--
ALTER TABLE `adm_access_code`
...
--
ALTER TABLE `countries`
  MODIFY `country_id` int(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=239;
--
...
--
-- AUTO_INCREMENT for table `programme_category`
--
ALTER TABLE `programme_category`
...
--
ALTER TABLE `qualification`
  MODIFY `qualificaton_type_id` int(11) NOT NULL AUTO_INCREMENT;
--
