...
<html>
	...
	<body>
		...
		<div class="row-fluid">
			...
			<div class="span9">
				<h2>Search Acceptance Fees Log</h2>
                <hr>
                <h3>Note:</h3>
                <ul>
                	<li>This form is to search payment records in the acceptance log</li>
                </ul>
                ...
                <form action="" method="POST" class="form-horizontal search_acceptance" id="search_acceptance" >
                   ...
                   <div class="input-prepend">
					...
					<div class="input-prepend">
						<span class="add-on"><i class="icon-chevron-down"></i></span>
						<select class="input-large" name="department_id" id="department_id" >
                    ...
                    <div class="input-prepend">
                        <span class="add-on"><i class="icon-chevron-down"></i></span>
                        <input type="text" name="form_number" placeholder="Applicant Number" class="input-medium" />
                    </div>
                    
                   <!-- <div class="input-prepend">
                        <span class="add-on"><i class="icon-chevron-down"></i></span>
                        <select class="input-xlarge" name="student_status" id="student_status" >
                            <option value="all" selected>--Student Status--</option>
                    ...
                    <div class="control-group">
                        <div class="controls offset5"> 
                    		<br> 
                          	<button type="submit" class="btn btn-primary" id="search_acc_acceptance_button">Search</button>
                        </div>
					</div>
...
<script src="js/search_acceptance.js"></script>
