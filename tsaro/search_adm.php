...
<html>
	...
	<body>
		...
		<div class="row-fluid">
			...
			<div class="span9">
				<h2>Successful Form Transactions log</h2>
                <hr>
                <h3>Note:</h3>
                <ul>
                	<li>This is to search successful form transactions record(s)</li>
                </ul>
                ...
                <form action="" method="POST" class="form-horizontal search_adm_access" id="search_adm_access" >
                    ...
                    <div class="input-prepend">
                        <span class="add-on"><i class="icon-chevron-down"></i></span>
                        <input type="text" name="form_number" placeholder="Applicant Number" class="input-large" />
                    </div>

                    <div class="control-group">
                        <div class="controls offset5"> 
                    		<br> 
                          	<button type="submit" class="btn btn-primary" id="search_adm_access_button">Search</button>
                        </div>
					</div>
