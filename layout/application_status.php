      	...
      	<?php 
	        if (isset($user_application_histories)) { 
	            ...
	            foreach ($user_application_histories as $user_application_history) {
	    			...
	    			switch ($track_status) {
	    				case 1:
	    					$status_label = '<span class="label label-warning">Approved for Processing</span>';
	    					break;
						case 2:
							$status_label = '<span class="label label-info">Processing</span>';
							break;
						case 3:
							$status_label = '<span class="label label-success">Verified</span>';
							break;
						case 4:
							$status_label = '<span class="label label-success">Dispatched</span>';
							break;
						default:
