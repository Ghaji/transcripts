<?php
    ...
    $query_count = "SELECT count(*) FROM app_histories WHERE applicant_id ='".$session->id."' AND application_flag = 1 AND status_flag = 4";
    ...
    // for this page
    $sql = "SELECT * FROM app_histories WHERE applicant_id ='".$session->id."' AND application_flag = 1 AND status_flag = 4 ORDER BY `application_no` DESC ";
    $sql .= "LIMIT {$per_page} ";
