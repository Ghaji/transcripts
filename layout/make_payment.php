...
<form action="pay.php" method="POST" class="create_form form-horizontal" >
    ...
    <hr>
    <div class="label label-info">Please click the proceed button to proceed and view payment summary before making payment</div>    
    <hr>
    <div class="control-group">
        <div class="controls">   
            <button type="submit" class="btn btn-primary" id="submit"><i class=" icon-ok"> </i> Proceed</button>
